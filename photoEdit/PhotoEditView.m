...
-(UIView *)topView{
    if(!_topView){
        _topView = [[UIView alloc]initWithFrame:CGRectMake(0, 0,device_width, device_height-125)];
...
-(UIView *)bottomView{
    if(!_bottomView){
        ...
        _bottomView = [[UIView alloc]initWithFrame:CGRectMake(0,device_height-125,device_width,125)];
...
-(UIScrollView *)colorCategory{
    if(!_colorCategory){
        _colorCategory = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, device_width, 70)];
...
-(UIScrollView *)fontCategory{
    if(!_fontCategory){
        _fontCategory = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, device_width, 70)];
...
-(UIView *)cutCategory{
    if(!_cutCategory){
        ...
        _cutCategory = [[UIView alloc]initWithFrame:CGRectMake(0, 0, device_width, 70)];
...
-(UIButton *)leftRotateBtn{
    ...
    if(!_leftRotateBtn){
        ...
        _leftRotateBtn = [UIButton initWithFrame:CGRectMake(device_width/2-60, 15, 40, 40) normalImage:[UIImage imageNamed:@"left"] selectedImage:nil];
...
-(UIButton *)rightRotateBtn{
    if(!_rightRotateBtn){
        ...
        _rightRotateBtn = [UIButton initWithFrame:CGRectMake(device_width/2+40, 15, 40, 40) normalImage:[UIImage imageNamed:@"right"] selectedImage:nil];
...
-(UIView *)toolView{
    if(!_toolView){
        _toolView = [[UIView alloc]initWithFrame:CGRectMake(0, 70, device_width, 55)];
...
-(UIButton *)textBtn{
    if(!_textBtn){
        ...
        _textBtn = [UIButton initWithFrame:CGRectMake((device_width)/2-15, 15, 30, 30) normalImage:[UIImage imageNamed:@"fontSelect"] selectedImage:[UIImage imageNamed:@"fontSelected"]];
...
-(UIButton *)cutBtn{
    if(!_cutBtn){
        ...
        _cutBtn = [UIButton initWithFrame:CGRectMake(device_width/2+(self.textBtn.frame.origin.x-80)/2+15, 15, 30, 30) normalImage:[UIImage imageNamed:@"cutSelect"] selectedImage:[UIImage imageNamed:@"cutSelected"]];
...
-(UIButton *)okBtn{
    if(!_okBtn){
        ...
        _okBtn.frame = CGRectMake(device_width-80, 10, 80, 40);
